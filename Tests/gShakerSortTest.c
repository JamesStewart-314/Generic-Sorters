...
// Compilation Command: gcc gShakerSortTest.c ../genSorters.c -o executableProgram -I ../ -O
...
int main(int argc, char** argv) {
    ...
    */
    ...
    gShakerSort(compareFIntegers, random_numbers, (uint64_t)ARRAY_SIZE, (uint64_t)sizeof(int));
    ...
    */
    ...
    benchmarkInitialTime = clock();
    gShakerSort(compareFPerson, personArray, (uint64_t)ARRAY_SIZE, (uint64_t)(sizeof(Person)));
    benchmarkEndTime = clock();
