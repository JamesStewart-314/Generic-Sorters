...
// Compilation Command: gcc gSurpriseSortTest.c ../genSorters.c -o executableProgram -I ../ -O
...
int main(int argc, char** argv) {
    ...
    gSurpriseSort(compareFIntegers, random_numbers, (uint64_t)ARRAY_SIZE, (uint64_t)sizeof(int));
    ...
    benchmarkInitialTime = clock();
    gSurpriseSort(compareFPerson, personArray, (uint64_t)ARRAY_SIZE, (uint64_t)(sizeof(Person)));
    benchmarkEndTime = clock();
