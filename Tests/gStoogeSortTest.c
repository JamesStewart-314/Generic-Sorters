...
int main(int argc, char** argv) {
    ...
    */
    ...
    gStoogeSort(compareFIntegers, random_numbers, (uint64_t)ARRAY_SIZE, (uint64_t)sizeof(int));
    ...
    */    
    ...
    benchmarkInitialTime = clock();
    gStoogeSort(compareFPerson, personArray, (uint64_t)ARRAY_SIZE, (uint64_t)(sizeof(Person)));
    benchmarkEndTime = clock();
