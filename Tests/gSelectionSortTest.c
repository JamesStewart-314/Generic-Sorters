...
// Compilation Command: gcc gSelectionSortTest.c ../genSorters.c -o executableProgram -I ../ -O
...
int main(int argc, char** argv) {
    ...
    */
    ...
    gSelectionSort(compareFIntegers, random_numbers, (uint64_t)ARRAY_SIZE, (uint64_t)sizeof(int));
    ...
    */
    ...
    benchmarkInitialTime = clock();
    gSelectionSort(compareFPerson, personArray, (uint64_t)ARRAY_SIZE, (uint64_t)(sizeof(Person)));
    benchmarkEndTime = clock();
